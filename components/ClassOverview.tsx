...
import { ArrowRight, FileText, GraduationCap, MessageSquare, BrainCircuit, Files } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                    <div className="p-2 bg-blue-100 rounded-lg text-blue-600"><Files className="w-6 h-6" /></div>
             ...
             <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                    <div className="p-2 bg-emerald-100 rounded-lg text-emerald-600"><MessageSquare className="w-6 h-6" /></div>
                    <span className="px-2 py-1 rounded-full text-xs font-bold text-emerald-600 bg-emerald-50">
                        AI Powered
                    </span>
                </div>
                <div className="mt-4">
                    <h3 className="text-3xl font-bold text-slate-800">24/7</h3>
                    <p className="text-sm text-slate-400 font-medium">AI Tutor Access</p>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button onClick={() => onNavigate('study')} className="bg-white p-4 rounded-xl border border-slate-200 text-center hover:shadow-md hover:border-blue-300 transition-all group">
                <BrainCircuit className="w-8 h-8 mx-auto text-blue-500 mb-2"/>
                <span className="font-bold text-sm text-slate-700 group-hover:text-blue-600">Study Center</span>
              </button>
              ...
              <button onClick={() => onNavigate('docs')} className="bg-white p-4 rounded-xl border border-slate-200 text-center hover:shadow-md hover:border-blue-300 transition-all group">
                <Files className="w-8 h-8 mx-auto text-slate-500 mb-2"/>
                <span className="font-bold text-sm text-slate-700 group-hover:text-blue-600">Library</span>
              </button>
            </div>
