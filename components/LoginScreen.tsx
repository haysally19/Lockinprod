  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#0F172A] text-white flex-col justify-between p-12 overflow-hidden">
        ...
        {/* Animated Background Mesh - Toned down for performance */}
        <div className="absolute top-[-20%] right-[-20%] w-[600px] h-[600px] bg-blue-600/20 rounded-full blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-[-20%] left-[-20%] w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-[100px]"></div>
        
        {/* Content Layer */}
        <div className="relative z-10 h-full flex flex-col justify-center max-w-lg mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-400/20 text-blue-300 text-[10px] font-bold uppercase tracking-wider mb-6 w-fit">
            ...
            {/* Social Proof Card */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 flex items-center gap-4 hover:bg-white/10 transition-colors cursor-default max-w-sm">
      ...
      {/* RIGHT SIDE: High-Focus Form (With internal scrolling if needed) */}
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 relative overflow-y-auto">
        <div className="w-full max-w-[380px] animate-fade-in-up py-8">
            
            <div className="mb-6 text-center">
                {/* FIXED: Logo Size Constrained */}
            ...
            <button
                ...
                className="w-full h-11 bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 text-slate-700 font-bold rounded-xl transition-all flex items-center justify-center gap-2 group relative overflow-hidden mb-5 shadow-sm text-sm"
            >
            ...
            <div className="relative flex py-2 items-center mb-5">
                ...
                <span className="flex-shrink mx-4 text-slate-400 text-[10px] font-bold uppercase tracking-wider">Or continue with email</span>
                <div className="flex-grow border-t border-slate-100"></div>
            </div>

            {error && (
                <div className="mb-5 p-3 bg-red-50 border border-red-100 text-red-600 rounded-lg text-xs flex items-start gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                <div className="space-y-1">
                    <label className="text-[11px] font-bold text-slate-700 ml-1 uppercase tracking-wide">Email</label>
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 h-11 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-sm font-medium text-slate-900"
                ...
                <div className="space-y-1">
                    <label className="text-[11px] font-bold text-slate-700 ml-1 uppercase tracking-wide">Password</label>
                    <div className="relative group">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-11 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/30 transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 mt-4 text-sm"
                >
                    {isLoading ? (
            ...
            <div className="mt-6 text-center">
                <p className="text-slate-500 text-xs">
                    ...
                    <button
                        ...
                        className="ml-1.5 text-blue-600 font-bold hover:text-blue-700 transition-colors hover:underline"
                    >
            ...
            {/* Legal Links */}
            <div className="mt-6 pt-6 border-t border-slate-50 flex justify-center gap-4 text-[10px] text-slate-400">
